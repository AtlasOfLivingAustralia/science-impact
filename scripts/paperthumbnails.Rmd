...
In this area I need to place the correct colours (from `closest_matches') to insert into their respective positions - for the textbox, the backing colour (plot and panel) and also the small rectangle accent in the right hand corner. At this point, I could also just choose what colour goes where on the thumbnail myself. This might work better for colours that clash re. readability? This doesn't need to be a flow on automated process

My image (https://images.ala.org.au/image/viewer?imageId=c90c357e-debc-4bcf-bd6c-914de23d4ae3) has generated these colours
